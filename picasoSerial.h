...
extern WORD bus_In(void);
extern void bus_Out(WORD Bits);
extern WORD bus_Read(void);
extern void bus_Set(WORD IOMap);
extern void bus_Write(WORD Bits);
extern void file_Unmount(void);
extern void gfx_Button(WORD  Up, WORD  x, WORD  y, WORD  buttonColour, WORD  txtColour, WORD  font, WORD  txtWidth, WORD  txtHeight, char *  text);
...
extern WORD file_Count(char * Filename);
extern WORD file_Dir(char * Filename);
extern WORD file_Erase(char * Filename);
extern WORD file_Error(void);
extern WORD file_Exec(char *Filename, WORD  ArgCount, t4DWordArray  Args);
extern WORD file_Exists(char *Filename);
extern WORD file_FindFirst(char *Filename);
extern WORD file_FindFirstRet(char *Filename, char * StringIn);
extern WORD file_FindNext(void);
extern WORD file_FindNextRet(char * StringIn);
extern WORD file_GetS(char * StringIn, WORD  Size, WORD  Handle);
...
extern WORD file_LoadFunction(char *Filename);
extern WORD file_LoadImageControl(char *Datname, char *GCIName, WORD  Mode);
extern WORD file_Mount(void);
extern WORD file_Open(char * Filename, unsigned char  Mode);
extern WORD file_PlayWAV(char * Filename);
extern WORD file_PutC(unsigned char  Character, WORD  Handle);
extern WORD file_PutS(char * StringOut, WORD  Handle);
...
extern WORD file_Run(char *Filename, WORD  ArgCount, t4DWordArray  Args);
...
extern WORD putStr(char *InString);
extern WORD readString(WORD  Handle, char * StringIn);
extern WORD snd_Pitch(WORD  Pitch);
extern WORD snd_Playing(void);
extern WORD sys_GetModel(char *ModelStr);
...
extern WORD writeString(WORD  Handle, char * StringOut);
